    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Order By Last Name</h4>
        </div>
        <div class="modal-body text-center lead">
         <h3><i>View By Last Name</i></h3>
		...
		<!--====== Delete Button ========-->
		<a href="<?php echo base_url() . "index.php/last_name/delete_student_id/" . $contact->id; ?>" class="btn btn-danger" onclick="return confirm('Yes, Please Delete Contact!');">
		Delete</a>
		<?php endforeach; ?>
		</div>
